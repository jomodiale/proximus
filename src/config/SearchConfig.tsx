...
export const SearchPageTabConfig : SearchPageTabConfigType[] = [
  ...
  {
    caption: "MyProximus",
    expression: `@title=myproximus`,
    isActive: false,
    sideBarRecommendationConfig: [
      {
        pipeline: "default",
        NumberofResults: 6,
        title: "Related to MyProximus",
  ...
  {
    caption: "Television",
    expression: `@title=television`,
    isActive: false,
    facetToInclude: ["concepts","mynav2b", "mynav4b"],
  },
  {
    caption: "Internet",
    expression: `@title=internet`,
    isActive: false,
    sideBarRecommendationConfig: [
      {
        pipeline: "default",
  ...
  {
    caption: "Telephony",
    expression: `@title=telephony`,
    isActive: false,
    facetToInclude: ["concepts","mynav2b","mynav3b"],
  },
  {
    caption: "Billing",
    expression: `@title=billing`,
    isActive: false,
